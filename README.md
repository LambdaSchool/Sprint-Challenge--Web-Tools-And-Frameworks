...
1. How would you teach the basic ideas behind preprocessing to a friend?  Please don't copy and paste an answer here, use your own thoughts. (A syntax for CSS written in a different language )
2. What is the npm command to globally install LESS? (npm install -g less)
3. What is the most useful mixin you have used this week?  (the border mixin)
4. What are the names of the 5 breakpoints used in bootstrap? (extra small devices,small devices,medium devices,large devices,extra large devices)
